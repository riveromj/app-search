...
//
//   const coutry = Convert.toCoutry(json);
//
...
export class Convert {
  public static toCoutry(json: string): Coutry[] {
    return cast(JSON.parse(json), a(r('Coutry')));
  }

  public static coutryToJson(value: Coutry[]): string {
    return JSON.stringify(uncast(value, a(r('Coutry'))), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Currencies: o([{ json: 'VES', js: 'VES', typ: r('Ves') }], false),
  Ves: o(
    [
  ...
  Gini: o([{ json: '2006', js: '2006', typ: 3.14 }], false),
  Idd: o(
    [
  ...
  Languages: o([{ json: 'spa', js: 'spa', typ: '' }], false),
  Maps: o(
    [
  ...
  NativeName: o([{ json: 'spa', js: 'spa', typ: r('Translation') }], false),
  Translation: o(
    [
      { json: 'official', js: 'official', typ: '' },
      { json: 'common', js: 'common', typ: '' },
